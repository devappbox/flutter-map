...
abstract class $CartStateCopyWith<$Res> {
  ...
  $Res call({String? idItem, List<Item>? items});
}
...
class _$_CartState implements _CartState {
  const _$_CartState({required this.idItem, required final List<Item>? items})
      : _items = items;
  ...
  @override
  String toString() {
    return 'CartState(idItem: $idItem, items: $items)';
  }
...
abstract class _CartState implements CartState {
  const factory _CartState(
      ...
      required final List<Item>? items}) = _$_CartState;
