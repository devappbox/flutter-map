...
abstract class $ItemCopyWith<$Res> {
  ...
  $Res call({String id, String qty, String price});
}
...
class _$_Item extends _Item {
  const _$_Item({required this.id, required this.qty, required this.price})
      : super._();
  ...
  @override
  String toString() {
    return 'Item(id: $id, qty: $qty, price: $price)';
  }
...
abstract class _Item extends Item {
  const factory _Item(
      ...
      required final String price}) = _$_Item;
